...
public class QuizUnitTwoActivity extends AppCompatActivity {
    ...
    private QuestionsUnitTwo mQuestions;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_quiz_unit_two);

        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        getSupportActionBar().setTitle(getString(R.string.string_quiz_two_action_bar_title));
        numQuestion = 0;
        mQuestions = new QuestionsUnitTwo();
        ...
        btnQuizAnswerOne.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (btnQuizAnswerOne.getText() == mAnswer){
                    ...
                    Toast.makeText(QuizUnitTwoActivity.this, R.string.string_quiz_lbl_correct, Toast.LENGTH_SHORT).show();
                } else {
                    updateQuestion(numQuestion);
                    Toast.makeText(QuizUnitTwoActivity.this, R.string.string_quiz_lbl_incorrect, Toast.LENGTH_SHORT).show();
    ...
    private void gameOver(){
        AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(QuizUnitTwoActivity.this);
        alertDialogBuilder
