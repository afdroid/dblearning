...
public class QuizUnitOneActivity extends AppCompatActivity {
    ...
    private QuestionsUnitOne mQuestions;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_quiz_unit_one);

        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        getSupportActionBar().setTitle(getString(R.string.string_quiz_one_action_bar_title));
        numQuestion = 0;
        mQuestions = new QuestionsUnitOne();
        ...
        btnQuizAnswerOne.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (btnQuizAnswerOne.getText() == mAnswer){
                    ...
                    Toast.makeText(QuizUnitOneActivity.this, R.string.string_quiz_lbl_correct, Toast.LENGTH_SHORT).show();
                } else {
                    updateQuestion(numQuestion);
                    Toast.makeText(QuizUnitOneActivity.this, R.string.string_quiz_lbl_incorrect, Toast.LENGTH_SHORT).show();
    ...
    private void gameOver(){
        AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(QuizUnitOneActivity.this);
        alertDialogBuilder
